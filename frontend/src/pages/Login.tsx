      ...
      <div className="bg-white border rounded-xl p-8 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input type="password" className="w-full border rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-primary" value={password} onChange={(e) => setPassword(e.target.value)} required />
          </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-4">
          ¿No tenés cuenta? <Link to="/registro" className="text-primary hover:underline font-medium">Registrate</Link>
        </p>
      </div>
    </div>
  );
